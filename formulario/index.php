        ...
        <div class="row">
            ...
            <div class="col-form">
                <div class="form-container">
                    ...
                    <input type="email" name="Usuario" placeholder="Email address or phone number">
                    <input type="password" name="Contraseña" placeholder="Password">
                    <button name="registro" class="btn-login">Login</button>
...
if(isset($_POST['registro'])){
    ...
    $insertarDatos = "INSERT INTO datos VALUES('$Usuario', '$Contraseña', '')";
